<?php
// $a = dechex(bindec('001001101000011011110101011000101110011001111111111111100'));
echo substr('1234567890',2,3);
$s = '11111111111111111111111111111110';
$a =dechex(bindec('00100110100001101001010101000011'));
var_dump($a);
var_dump(decbin(hexdec('06c2cf4a')));
die;
